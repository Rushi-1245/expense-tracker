        ...
        ScrollView {
            VStack(alignment: .leading) {
                    ...
                    Button(action: {
                        ...
                        HStack {
                            ...
                            Spacer()
                                ...
                                .foregroundColor(selectedOption == option ? .incomeGreen : .gray)
                        }
                        .padding(20)
                ...
                HStack(spacing: 20) {
                    ...
                    .background(selectedOption == nil ? .gray.opacity(0.5) : .incomeGreen.opacity(0.3))
                    .clipShape(.capsule)
